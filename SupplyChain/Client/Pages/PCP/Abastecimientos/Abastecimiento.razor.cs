...
namespace SupplyChain.Pages.Absto
{
    public class AbastPageBase : ComponentBase
    {
        ...
        protected string claseSE = "btn btn-primary";
        protected string claseMP = "btn btn-outline-primary";

        public bool Enabled = true;
        public bool Disabled = false;
        public bool ShowSemi = false;
        public bool ShowMatP = false;
        ...
        public List<MenuItem> PcpItems = new List<MenuItem>{
        new MenuItem {Text="Previsión", Url="/prev"},
        new MenuItem {Text="Pendientes de entrega", Url="/PedPend"},
        new MenuItem {Text="Pendientes de fabricar", Url="/pendfab"},
        new MenuItem {Text="Planificación", Url="/prev"},
        new MenuItem {Text="Abastecimiento", Url="/Abastecimiento"},
        new MenuItem {Text="Fabricación", Url="/prev"},
        new MenuItem {Text="Carga De Máquina", Url="/prev"},};
